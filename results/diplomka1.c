void diplomka1(void)
{
    ...
    TH1F *hNInt = new TH1F("hNInt","Number of interactions for positron;Number of interactions",80,0,80);
    TH1F *hNIntA = new TH1F("hNIntA","Number of interaction in the active volumes for positron;Number of interaction",80,0,80);
    TH1F *hNIntP = new TH1F("hNIntP","Number of interaction in the pasive volumes for positron;Number of interaction",80,0,80);

    TNtupleD* ntupleE = (TNtupleD*)f->Get("ntupleE");
    ...
    TH1F *hEne = new TH1F("hEne","Deposited energy of positron;E [MeV]",100,0,10);
    TH1F *hEneA = new TH1F("hEneA","Deposited energy of positron;E [MeV]",100,0,10);
    TH1F *hEneP = new TH1F("hEneP","Deposited energy of positron;E [MeV]",100,0,10);
    ...
    TH1F *hDist = new TH1F("hDist","Track length and distance from vertex for positron;Length [mm]",100,0,100);
    TH1F *hTrackLen = new TH1F("hTrackLen","Track length and distance from vertex for positron;Length [mm]",100,0,100);
    ...
    TH1F *hMult = new TH1F("hMult","Multiplicity of hits for positron;Number of hitted plates",10,0,10);
